...
#define ARGS_IMPL2(n, ...) ARGS_##n(__VA_ARGS__)
#define ARGS_IMPL(n, ...) ARGS_IMPL2(n, __VA_ARGS__)
#define ARGS(...) ARGS_IMPL(VA_NARGS(__VA_ARGS__), __VA_ARGS__)

#define ARGS_1(ty1) \
	ty1 t##0, \
	t##0

#define ARGS_2(ty1, ty2) \
	ty1 t##0; ty2 t##1, \
	t##0, t##1

#define ARGS_3(ty1, ty2, ty3) \
	ty1 t##0; ty2 t##1; ty3 t##2, \
	t##0, t##1, t##2

#define ARGS_4(ty1, ty2, ty3, ty4) \
	ty1 t##0; ty2 t##1; ty3 t##2; ty4 t##3, \
	t##0, t##1, t##2, t##3

#define ARGS_5(ty1, ty2, ty3, ty4, ty5) \
...
#define DEFINE_ASYNC(fn, args) DEFINE_ASYNC_IMPL(fn, ARGS args)
#define DEFINE_ASYNC_IMPL(fn, ...) ASYNC_DECL(fn, __VA_ARGS__)

#define DEFINE_FUTURE(rty, fn, args) DEFINE_FUTURE_IMPL(rty, fn, ARGS args)
#define DEFINE_FUTURE_IMPL(rty, fn, ...) FUTURE_DECL(rty, fn, __VA_ARGS__)

#ifdef LAZY_FUTURES
#define DEFINE_LAZY_FUTURE(rty, fn, args) DEFINE_LAZY_FUTURE_IMPL(rty, fn, ARGS args)
#define DEFINE_LAZY_FUTURE_IMPL(rty, fn, ...) LAZY_FUTURE_DECL(rty, fn, __VA_ARGS__)
#endif
